...
Namespace DXSample
	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class OrdersDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute()> _
			Public Function AddOrdersRow(ByVal OrderDate As System.DateTime, ByVal RequiredDate As System.DateTime, ByVal ShipVia As Integer, ByVal Freight As Decimal, ByVal ShipCity As String) As OrdersRow
				Dim rowOrdersRow As OrdersRow = (CType(Me.NewRow(), OrdersRow))
				Dim columnValuesArray() As Object = { Nothing, OrderDate, RequiredDate, ShipVia, Freight, ShipCity}
...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class OrdersTableAdapter
		...
		Private Sub InitAdapter()
			...
			Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Orders` WHERE ((`OrderID` = ?) AND ((? = 1 AND `OrderDate` IS NULL) OR (`OrderDate` = ?)) AND ((? = 1 AND `RequiredDate` IS NULL) OR (`RequiredDate` = ?)) AND ((? = 1 AND `ShipVia` IS NULL) OR (`ShipVia` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)) AND ((? = 1 AND `ShipCity` IS NULL) OR (`ShipCity` = ?)))"
			...
			Me._adapter.InsertCommand.CommandText = "INSERT INTO `Orders` (`OrderDate`, `RequiredDate`, `ShipVia`, `Freight`, `ShipCit" & "y`) VALUES (?, ?, ?, ?, ?)"
			...
			Me._adapter.UpdateCommand.CommandText = "UPDATE `Orders` SET `OrderDate` = ?, `RequiredDate` = ?, `ShipVia` = ?, `Freight` = ?, `ShipCity` = ? WHERE ((`OrderID` = ?) AND ((? = 1 AND `OrderDate` IS NULL) OR (`OrderDate` = ?)) AND ((? = 1 AND `RequiredDate` IS NULL) OR (`RequiredDate` = ?)) AND ((? = 1 AND `ShipVia` IS NULL) OR (`ShipVia` = ?)) AND ((? = 1 AND `Freight` IS NULL) OR (`Freight` = ?)) AND ((? = 1 AND `ShipCity` IS NULL) OR (`ShipCity` = ?)))"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT OrderID, OrderDate, RequiredDate, ShipVia, Freight, ShipCity FROM Orders"
		...
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_RequiredDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_ShipVia As Global.System.Nullable(Of Integer), ByVal Original_Freight As Global.System.Nullable(Of Decimal), ByVal Original_ShipCity As String) As Integer
			...
			If (Original_ShipVia.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(6).Value = (CInt(Fix(Original_ShipVia.Value)))
			Else
			...
			If (Original_Freight.HasValue = True) Then
				...
				Me.Adapter.DeleteCommand.Parameters(8).Value = (CDec(Original_Freight.Value))
			Else
			...
			Else
				...
				Me.Adapter.DeleteCommand.Parameters(10).Value = (CStr(Original_ShipCity))
			End If
		...
		Public Overridable Function Insert(ByVal OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal RequiredDate As Global.System.Nullable(Of Global.System.DateTime), ByVal ShipVia As Global.System.Nullable(Of Integer), ByVal Freight As Global.System.Nullable(Of Decimal), ByVal ShipCity As String) As Integer
			...
			If (ShipVia.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(2).Value = (CInt(Fix(ShipVia.Value)))
			Else
				Me.Adapter.InsertCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			If (Freight.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(3).Value = (CDec(Freight.Value))
			Else
			...
			Else
				Me.Adapter.InsertCommand.Parameters(4).Value = (CStr(ShipCity))
			End If
		...
		Public Overridable Function Update(ByVal OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal RequiredDate As Global.System.Nullable(Of Global.System.DateTime), ByVal ShipVia As Global.System.Nullable(Of Integer), ByVal Freight As Global.System.Nullable(Of Decimal), ByVal ShipCity As String, ByVal Original_OrderID As Integer, ByVal Original_OrderDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_RequiredDate As Global.System.Nullable(Of Global.System.DateTime), ByVal Original_ShipVia As Global.System.Nullable(Of Integer), ByVal Original_Freight As Global.System.Nullable(Of Decimal), ByVal Original_ShipCity As String) As Integer
			If (OrderDate.HasValue = True) Then
			...
			End If
			If (ShipVia.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(2).Value = (CInt(Fix(ShipVia.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
			If (Freight.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(3).Value = (CDec(Freight.Value))
			Else
			...
			Else
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CStr(ShipCity))
			End If
			Me.Adapter.UpdateCommand.Parameters(5).Value = (CInt(Fix(Original_OrderID)))
			If (Original_OrderDate.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(6).Value = (CObj(0))
				Me.Adapter.UpdateCommand.Parameters(7).Value = (CDate(Original_OrderDate.Value))
			Else
			...
			If (Original_RequiredDate.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(9).Value = (CDate(Original_RequiredDate.Value))
			Else
			...
			If (Original_ShipVia.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(11).Value = (CInt(Fix(Original_ShipVia.Value)))
			Else
			...
			If (Original_Freight.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(13).Value = (CDec(Original_Freight.Value))
			Else
			...
			Else
				...
				Me.Adapter.UpdateCommand.Parameters(15).Value = (CStr(Original_ShipCity))
			End If
